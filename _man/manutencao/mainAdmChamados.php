...
$chamado_tipo        = $_POST['chamado_tipo'];
$chamado_departamento           = $_POST['chamado_departamento'];
$chamado_responsavel       = trim($_POST['chamado_responsavel']);
$chamado_assunto                 = trim($_POST['chamado_assunto']);
$chamado_servico                 = trim($_POST['chamado_servico']);
