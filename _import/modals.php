                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row form-group col-lg-12">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="modelo_" name="modelo_"/>
                                                </div>
                                                <div class="col-sm-2">
                                                    <label for="serie_">Série:</label>
                                                    <input type="text" class="form-control" id="serie_" name="serie_"/>
                                                </div>
                                                <div class="col-sm-3">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row form-group col-lg-12">
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" class="form-control" id="cpf_cnpj_dest_" name="cpf_cnpj_dest_"/>
                                                </div>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="row form-group col-lg-12">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="cep_dest_" name="cep_dest_"/>
                                                </div>
                                            </div>
                                            <div class="row form-group col-lg-12">
                                                <div class="col-sm-5">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row form-group col-lg-12">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="telefone_emit_" name="telefone_emit_"/>
                                                </div>
                                                <div class="col-sm-1">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" class="form-control" id="insc_estadual_emit_" name="insc_estadual_emit_"/>
                                                </div> 
                                            </div> 
                                            <div class="row form-group col-lg-12">
                                                <div class="col-sm-3">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <input type="text" class="form-control" id="insc_municipal_emit_" name="insc_municipal_emit_"/>
                                                </div>                                                                                   
                                                <div class="col-sm-3">
