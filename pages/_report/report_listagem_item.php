<?php
    ...
    WHERE menu_submenu_url  = 'adm_participantes';");
?>
<div class="content-wrapper">
    ...
    <section class="content">
       ...
       <!-- INICIAMOS O MODO TELA -->
        <?php  
        $search = explode("&",$_SESSION["buscas"]);
                
//                   print"<pre>";
//   print_r(explode("&",$_SESSION["buscas"]));
//   exit;
        
        if ( $_SESSION['op'] == "" ){
          
          $buscas = explode("&",$_SESSION["buscas"]);
          $sintetico = explode("=",$search[0])[1] == "" ? "S" : explode("=",$search[0])[1];
          $col_codigo = explode("=",$search[1])[1] == "" ? "S" : explode("=",$search[1])[1];
          $totais = explode("=",$search[2])[1] == "" ? "S" : explode("=",$search[2])[1];
      ...
      <div class="card body-view">
          <div class="row">
              <div class="col-sm-10">
                  <input type="hidden" class="buscas send_print" id="sintetico_detail" name="sintetico_detail" value="<?= $sintetico ?>"/>
                  <input type="hidden" class="buscas send_print" id="col_codigo" name="col_codigo" value="<?= $col_codigo ?>"/>
                  <input type="hidden" class="buscas send_print" id="exibe_totais" name="exibe_totais" value="<?= $totais ?>"/>
                  
                  <button type="button" id="btnDetail" class="alert-<?= $sintetico == "S" ? "info" : "warning" ?> btn" >
                      <span class="fa-detail"></span> <?= $sintetico == "S" ? "SINTÉTICO" : "DETALHADO" ?>
                  </button>
                  <button type="button" id="btnColCodigo" class="alert-<?= $col_codigo == "S" ? "info" : "danger" ?> btn" >
                      <span class="fa-detail"></span> Coluna Código
                  </button>
                  <button type="button" id="btnExibeTotais" class="alert-<?= $totais == "S" ? "info" : "danger" ?> btn" >
                      <span class="fa-detail"></span> Exibe Totais
                  </button>
              </div> 
              <div class="col-sm-2">
                  <button type="button" id="planilhaPrint" class="btn btn-success">
          ...
          "SELECT  
            ...
            <div class="col-sm-12">
               <table class="table">
                    ...
                    <thead>
                        <tr>
                            <?= $col_codigo == "S" ? '<th width="10%">Código          </th>' : '' ?>
                            <th width="30%">Descrição       </th>
                            <th width="20%">NCM             </th>
                            <th width="10%">Unidade         </th>
                            <th width="10%">Tipo            </th>
                            <th width="5%" class="text-center">Detalhar           </th>
                        </tr>
                    </thead>
                    <?php }else{ ?>
                        <thead>
                            <tr>
                                <?= $col_codigo == "S" ? '<th width="5%">Código          </th>' : '' ?>
                        ...
                        <tbody>
                                <?php if ( $dados->RecordCount() > 0 ){ ?>
                                    <?php while ( !$dados->EOF ) { 
                                        ...
                                        ?>
                                            <tr>
                                                <?= $col_codigo == "S" ? '<th width="10%">'.$dados->fields['item_codigo'].'          </th>' : '' ?>
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-success" onclick="movPage('report_listagem_item','view','<?= $dados->fields['item_id'] ?>', 'movimentacao','','')" title="Clique para visualizar a informação.">
                                ...
                                <?php if ( $totais == "S" ){ ?>
                                    <td colspan="7" class="text-left"><h4>Total de Itens Referente - <?= $itens->fields['item_tipo_detail'] ?> - <?= $itens->fields['qtd_itens'] ?></h4></td>
                                <?php  } ?>
      ...
      <div class="card body-view">
        ...
        <div class="card-body">
            <form action="<?= $_SERVER['localhost']?>/sys/_man/manutencao/mainAdmItem.php" method="post" id="frmDados">
                            ...
                            <div class="row col-sm-12">
                                <div  class="col-sm-2  mb-2">
                                    ...
                                    <select class="form-control requeri" id="item_tipo" name="item_tipo">
                                        ...
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "01" ? "selected" : "" ?>>01: Matéria-Prima;            </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "02" ? "selected" : "" ?>>02: Embalagem;                </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "03" ? "selected" : "" ?>>03: Produto em Processo;      </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "04" ? "selected" : "" ?>>04: Produto Acabado;          </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "05" ? "selected" : "" ?>>05: Subproduto;               </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "06" ? "selected" : "" ?>>06: Produto Intermediário;    </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "07" ? "selected" : "" ?>>07: Material de Uso e Consumo;</option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "08" ? "selected" : "" ?>>08: Ativo Imobilizado;        </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "09" ? "selected" : "" ?>>09: Serviços;                 </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "10" ? "selected" : "" ?>>10: Outros insumos;           </option>
                                        <option value="00" <?php print $dados->fields['item_tipo'] == "99" ? "selected" : "" ?>>99: Outras                    </option>
                                    </select>
                                </div>
                                <div  class="col-sm-2  mb-2">
                            ...
                            <div class="row col-sm-12">
                                ...
                                <div class="col-sm-5 mb-2">
                                    ...
                                    <select class="form-control requeri " id="item_cod_lst" name="item_cod_lst" <?=$disabled?> title="Código do serviço conforme lista do Anexo I da Lei Complementar Federal nº 116/2003"> 
                                        ...
                                        <option value="3.03" <?= $dados->fields['item_cod_lst'] == "303" ? "selected" : "selected" ?> > 3.03 -	Exploração de salões de festas, centro de convençõ </option>
                                        ...
                                        <option value="40.01" <?= $dados->fields['item_cod_lst'] == "4001" ? "selected" : "" ?> > <?= $dados->fields['item_cod_lst'] ?> 40.01 -	Obras de arte sob encomenda.                    </option>
                                    </select>
                                </div>                                   
        ...
        <div class="card-footer  align-content-center">
            <div class="row">          
                ...
                <?php } ?>
                <div class="col-sm-2 ">                  
                  <button type="button" class="btn btn-warning " id="btnVoltar" onclick="movPage('report_listagem_item','','', 'movimentacao','','')">
...
<script type="text/javascript">
    ...
    $(document).ready(function($){
        ...
        $("#planilhaPrint").on("click", function(){
           window.open("./pages/_report/_mpdf/report_listagem_item.php?" + $(".send_print").serialize()  , "_blank"); 
        });
       ...
       $("#participante_endereco_cep").on("change",function(){
        ...
        $("#btnDetail").on("click", function(){
            var sintetico = $("#sintetico_detail").val();
            
            if ( sintetico == "D" ){
                $("#sintetico_detail").val("S");
            }
            else {
                $("#sintetico_detail").val("D");
            }
            
            chamaMovim();

        });
        $("#btnColCodigo").on("click", function(){
             var sintetico = $("#col_codigo").val();
        ...
        $("#btnExibeTotais").on("click", function(){
             var sintetico = $("#exibe_totais").val();
        ...
        function chamaMovim(){ movPage('report_listagem_item','','', 'movimentacao','',''); }
