...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gerenciamento dos Sub-Menus</h1>
          </div>
          <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    <table class="table">
                        <thead>
                            <tr>
                                <th width="10%">#                </th>
                                <th width="20%">Menu Principal   </th>
                                <th width="20%">SubMenu Descrição</th>
                                <th width="20%">SubMenu Categoria</th>
                                <th width="20%">URL              </th>
                        ...
                        <select class="form-control requeri" id="menu_id" name="menu_id">
                            ...
                            <?php $menu = $bd->Execute("SELECT menu_id, menu_descricao FROM t_menu order by 2;"); 
                                while ( !$menu->EOF ){ 
                                    ...
                                    <option value="<?= $menu->fields['menu_id'] ?>" <?= $selected ?>><?= $menu->fields['menu_descricao'] ?></option>
