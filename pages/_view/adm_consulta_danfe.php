...
<section class="content">
    <div class="card body-view">
        <div class="card-header">          
            <div class="row">
                <div class="col-sm-12">           
                <span class="fas fa-search"></span> <label> NF-e </label> 
                </div>
            </div>
        </div> 
        <div class="card-body">
                    ...
                    <tbody>
                        <?php 
                            for ( $x=0; $x <= 10; $x++ ){
                                print '
                                <tr>
                                    <td class=""><input type="checkbox" name="checkbox" class="check_nota"></td>
                                    ...
                                    <td>
                                        <div class="row col-sm-12">
                                            ...
                                            <div class="col-sm-2 openDetalhes">
                                                <span class="fas fa-tags openDetalhes"></span>
                                            </div>
                                            <div class="col-sm-2">
...
$(document).ready(function(){    
    ...
    /*$('#modalRegistroPadraoMadeira').on('show.bs.modal', function(event){
