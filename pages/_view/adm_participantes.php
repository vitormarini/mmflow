                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?= formataCpfCnpj($dados->fields['participante_codigo'],$dados->fields['participante_tipo'])    ?></td>
                                <td class="text-left"  ><?= $dados->fields['participante_nome']    ?></td>
                                <td class="text-left"  ><?= $dados->fields['participante_cliente']              ?></td>
                                <td class="text-left"  ><?= $dados->fields['participante_fornecedor']              ?></td>
                                <td class="text-left"  ><?= $dados->fields['participante_ie']              ?></td>
