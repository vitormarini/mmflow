                ...
                <form action="<?= $_SERVER['localhost'] ?>/mmflow/_man/manutencao/mainAdmItem.php" method="post" id="frmDados">
                    ...
                    <div class="tab-content" style="margin-top: 20px">
                            ...
                            <div class="row">
                                ...
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-sm-2 form-group ">
                                        <label for="item_aliq_icms" class="requi">Alíquota ICMS (%):</label>
                        ...
                        <div class="tab-pane margin-top-15 <?= ($_SESSION['aba'] == "aba-dados-gerenciais" ? "active" : "") ?>" id="dados_gerenciais" role="tabpanel">
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="row col-sm-12">
                                    <div class="col-sm-5  mb-2">
                                        ...
                                        <input type="text" onkeydown="javascript: fMasc( this, mCNPJ );" class="form-control requeri unique" id="fornecedor" name="fornecedor" placeholder="BUSCAR POR CPF/CNPJ OU RAZÃO SOCIAL" />
                                    </div>
                                    <div class="col-sm-5  mb-2">
                                        <label>Descrição:</label>
                                        <input type="text" class="form-control requeri unique" id="descricao_gerenciais" name="descricao_gerenciais" placeholder="INFORME A DESCRIÇÃO" />
                                    </div>
                                    <div class="col-sm-1">
                                ...
                                <div class="col-sm-12" style="margin: 10px 10px 10px 2px;">
                                    <table class="table">
                                        <tbody>
                                            <tr>
                                                <th class="text-center" colspan="8" style="background-color: #E0E0E0; border: 2px solid white; border-radius: 8px;">Descrições</th>
                                            </tr>
                                            <tr>
                                                ...
                                                <th class="text-left" width="10%"> Ação</th>
                                            </tr>
                                            <tr>
                            ...
                            <h4> Modulando as Unidades de Entrada e Valores de Conversão </h4>
                            <div class="row" style="margin-top: 10px">
                                <div class="row col-sm-12">
                                    <div class="col-sm-4  mb-2">
                                        <label>Fornecedor:</label>
                                        <input type="text" onkeydown="javascript: fMasc( this, mCNPJ );" class="form-control requeri unique" id="fornecedorMod" name="fornecedorMod" placeholder="BUSCAR POR CPF/CPNJ OU RAZÃO SOCIAL " />
                                    </div>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-left" width="20%"> Conversão</th>
                                                <th class="text-left" width="20%"> Ação</th>
                                            </tr>
                                            <tr>
                                                <td class="text-left"> Fornecedor </td>
                                                <td class="text-left"> 00/00/0000 </td>
                                ...
                                <div class="row col-sm-12">
                                    ...
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <select class="form-control endereco" id="baixo_estoque" name="baixo_estoque">
                                            ...
                                            <option value="nãoA"> NÃO </option>
                                        </select>
                                    </div>
                                </div>
                                <h6> Especificações do item </h6>
                                <div class="row" style="margin-top: 10px">
                                    <div class="row col-sm-12">
                                        <div class="col-sm-4  mb-2">
                                            <label>Altura</label>
                                ...
                                <div class="row col-sm-12">
                                    ...
                                    <div class="row col-sm-12" style="margin-left: 5px;">
                                        ...
                                        <div class="col-sm-1 form-group" style="margin-right: 10px;">
                                            ...
                                            <select class="form-control endereco" id="csosnFiscal" name="csosnFiscal">
                                                ...
                                                <option value="nãoCSO"> NÃO </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row col-sm-12" style="margin-left: 5px;">
                                    ...
                                    <div class="row col-sm-12" style="margin-left: 5px;">
                                        ...
                                        <div class="col-sm-2 form-group" style="margin-right: 0px;">
                                            <label for="cfopFiscal">Benefício Fiscal</label>
                                            <select class="form-control endereco" id="benFiscal" name="benFiscal">
                                                <option value="">SELECIONE</option>
                                                <option value="simBen"> SIM </option>
                                                <option value="nãoBen"> NÃO </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-2  mb-2" style="margin-right: 0px;">
                                            <label>Redução ICMS EF %</label>
                                    ...
                                    <div class="row col-sm-12" style="margin-left: 5px;">
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <select class="form-control endereco" id="cstpFiscal" name="cstpFiscal">
                                                ...
                                                <option value="nãoCSPT"> NÃO </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3  mb-2" style="margin-right: 0px;">
                                            <label for="cfopFiscal">Tipo de cálculo</label>
                                            <select class="form-control endereco" id="tipoCalc" name="tipoCalc">
                                                <option value="">SELECIONE</option>
                                                <option value="simCalc"> SIM </option>
                                                <option value="nãoCalc"> NÃO </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3  mb-2">
                                            <label>Alíquota (%)</label>
                                    ...
                                    <div class="row col-sm-12" style="margin-left: 5px;">
                                        <div class="col-sm-3 form-group">
                                            ...
                                            <select class="form-control endereco" id="cofinsCst" name="cofinsCst">
                                                ...
                                                <option value="nãoCofins"> NÃO </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3  mb-2" style="margin-right: 0px;">
                                            <label for="calcCofins">Tipo de cálculo</label>
                                            <select class="form-control endereco" id="calcCofins" name="calcCofins">
                                                <option value=""> SELECIONE</option>
                                                <option value="sCalCo"> SIM </option>
                                                <option value="nCalCo"> NÃO </option>
                                            </select>
                                        </div>
                                        <div class="col-sm-3  mb-2">
                                            <label>Alíquota (%)</label>
