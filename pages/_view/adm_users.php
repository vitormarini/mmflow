<?php
    ...
    WHERE menu_submenu_url  = 'adm_users';");
?>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php if ( $dados->RecordCount() > 0 ){ ?>
                                <?php while ( !$dados->EOF ) { ?>
                            <tr>
                                <td class="text-left"><img src="dist/img/user_<?=$dados->fields['user_id']?>.jpg" class="img-circle elevation-2" alt="No Image" style="width: 40px; height: 40px;"></td>
