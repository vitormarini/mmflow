                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                if ($dados->RecordCount() > 0) {
                                    while (!$dados->EOF) { ?>
                                        <tr>
                                            <td class="text-center">  <!-- <img src="dist/img/user_<?= $dados->fields['user_id'] ?>.png" --> <img src="dist/img/user_.png" class="img-circle elevation-2" alt="No Image" style="width: 40px; height: 40px;"></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function($) {
        ...
        $("#aba-user-geral").on("click", function() {
            $("#btnSalvar, #btnExcluir, #btnVoltar, .profile").show();
        });
        $("#aba-user-permissoes").on("click", function() {
            $("#btnSalvar, #btnExcluir, #btnVoltar, .profile").hide();
        });
